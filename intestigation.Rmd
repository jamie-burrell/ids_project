...
raceresults_cleaned %>%
  ...
  gghighlight(driver %in% c("Jean-Éric Vergne", "Sébastien Buemi", "Lucas di Grassi", "Stéphane Sarrazin", "Maximilian Günther"), label_key = driver)


formula_e_race_results %>%
  filter(driver %in% c("Jean-Éric Vergne", "Sébastien Buemi", "Lucas di Grassi", "Stéphane Sarrazin", "Maximilian Günther")) %>%
  ggplot(mapping = aes(
    x = driver,
    y = rank_num,
    fill = driver
