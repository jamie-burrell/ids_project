...
style_xaringan(
  ...
  background_color = "#1F4257", "#F97B64", "white"
)
...
# model selection (Hylda) the code below is just an example of how to insert code, you can delete that
...
```{r plot from investigation, echo = FALSE}
...
# model evaluation including limitaions and possibilities for future study (Jamie)

- can edit font size like this <font size="10">How is driver performance affected by their team, the track, their age and any other factors?</font>
