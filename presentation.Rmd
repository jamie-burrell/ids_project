...
author: "Table 5 Tekkers <br> Joel, Jamie, Yara, Farhan, Hylda, Aiman"
...
#Background image
style_xaringan(
  title_slide_background_image = "img/download.jpeg",
  title_slide_text_color = "white",
  background_color = "#1F4257", "#F97B64"
...
- How does the grid number affect the rank position for the four drivers who have all been in 69 races (Daniel Abt, Jérôme D’Ambrosio, Lucas di Grassi and Sam Bird)?

- We selected the Formula E data set with a view to analysing the factors which affect driver performance. We were keen to explore how the team, the track or even the age of the driver affects how well they perform in Formula E races.
